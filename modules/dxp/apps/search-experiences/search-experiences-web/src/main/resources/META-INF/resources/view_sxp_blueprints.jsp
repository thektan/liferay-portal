...
<portlet:actionURL name="<%= SXPBlueprintsMVCCommandNames.DELETE_BLUEPRINT %>" var="deleteBlueprintURL">
	...
	<aui:form method="post" name="fm">
		...
		>
			<liferay-ui:search-container-row
				className="com.liferay.search.experiences.sxp_blueprints.model.Blueprint"
