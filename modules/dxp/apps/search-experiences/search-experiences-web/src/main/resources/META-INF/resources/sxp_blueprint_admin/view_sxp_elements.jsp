...
<portlet:actionURL name="/sxp_blueprints_admin/delete_sxp_element" var="deleteSXPElementURL">
	<portlet:param name="redirect" value="<%= currentURL %>" />
</portlet:actionURL>

<portlet:actionURL name="/sxp_blueprints_admin/edit_sxp_element" var="hideSXPElementURL">
	<portlet:param name="redirect" value="<%= currentURL %>" />
	<portlet:param name="<%= Constants.CMD %>" value="hide" />
	<portlet:param name="hidden" value="<%= Boolean.TRUE.toString() %>" />
</portlet:actionURL>

<portlet:actionURL name="/sxp_blueprints_admin/edit_sxp_element" var="showSXPElementURL">
	<portlet:param name="redirect" value="<%= currentURL %>" />
	<portlet:param name="<%= Constants.CMD %>" value="hide" />
...
<clay:management-toolbar
	...
	propsTransformer="sxp_blueprints_admin/js/view_sxp_elements/SXPElementEntriesManagementToolbarPropsTransformer"
	...
	<aui:form method="post" name="fm">
		...
		>
			<liferay-ui:search-container-row
				...
				modelVar="entry"
			>
				<%@ include file="/sxp_blueprints_admin/sxp_element_search_columns.jspf" %>
			</liferay-ui:search-container-row>
