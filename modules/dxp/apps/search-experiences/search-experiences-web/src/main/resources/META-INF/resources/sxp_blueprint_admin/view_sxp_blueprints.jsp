...
<portlet:actionURL name="/sxp_blueprints_admin/delete_sxp_blueprint" var="deleteSXPBlueprintURL">
...
<clay:management-toolbar
	...
	propsTransformer="sxp_blueprints_admin/js/view_sxp_blueprints/SXPBlueprintEntriesManagementToolbarPropsTransformer"
	...
	<aui:form method="post" name="fm">
		...
		>
			<liferay-ui:search-container-row
				...
				modelVar="entry"
			>
				<%@ include file="/sxp_blueprints_admin/sxp_blueprint_search_columns.jspf" %>
			</liferay-ui:search-container-row>
