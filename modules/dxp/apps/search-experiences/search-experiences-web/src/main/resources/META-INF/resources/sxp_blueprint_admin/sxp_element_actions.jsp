...
>
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, sxpElement, ActionKeys.UPDATE) %>">
		<portlet:renderURL var="editEntryURL">
			<portlet:param name="mvcRenderCommandName" value="/sxp_blueprints_admin/edit_sxp_element" />
	...
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, companyGroupId, SXPActionKeys.ADD_SXP_ELEMENT) %>">
		<portlet:actionURL name="/sxp_blueprints_admin/copy_sxp_element" var="copyEntryURL">
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="sxpElementId" value="<%= String.valueOf(sxpElementId) %>" />
		</portlet:actionURL>
	...
	<portlet:resourceURL id="/sxp_blueprints_admin/export_sxp_element" var="exportEntryURL">
		<portlet:param name="redirect" value="<%= currentURL %>" />
		<portlet:param name="sxpElementId" value="<%= String.valueOf(sxpElementId) %>" />
	</portlet:resourceURL>
	...
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, sxpElement, ActionKeys.UPDATE) %>">
		<portlet:actionURL name="/sxp_blueprints_admin/edit_sxp_element" var="hideEntryURL">
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="sxpElementId" value="<%= String.valueOf(sxpElementId) %>" />
	...
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, sxpElement, ActionKeys.DELETE) && !sxpElement.getReadOnly() %>">
		<portlet:actionURL name="/sxp_blueprints_admin/element_sxp_element" var="deleteEntryURL">
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="sxpElementId" value="<%= String.valueOf(sxpElementId) %>" />
		</portlet:actionURL>
