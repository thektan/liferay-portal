			...
			(textEmbeddingProviderConfiguration, index) => {
				...
				if (
					!textEmbeddingProviderConfiguration.attributes
						?.modelClassNames?.length
				) {
					errors.textEmbeddingProviderConfigurations[
						index
					].attributes.modelClassNames = sub(
			...
			<>
				...
				<div className="sheet-section">
					...
					<Input
						...
						name={`textEmbeddingProviderConfigurations[${index}].attributes.modelClassNames`}
						onBlur={_handleInputBlur(
							`textEmbeddingProviderConfigurations[${index}].attributes.modelClassNames`
						)}
						onChange={_handleInputChange(
							`textEmbeddingProviderConfigurations[${index}].attributes.modelClassNames`
						)}
