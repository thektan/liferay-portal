...
package com.liferay.search.experiences.web.internal.blueprint.portlet.configuration.icon;
...
@Component(
	...
	property = {
		...
		"path=" + SXPBlueprintMVCCommandNames.VIEW_SXP_BLUEPRINTS,
		"path=" + SXPBlueprintMVCCommandNames.VIEW_SXP_ELEMENTS, "path=-"
	},
	...
	public String getOnClick(
		...
		String portletURLString = PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				portletRequest, SXPPortletKeys.SXP_BLUEPRINT,
				PortletRequest.RENDER_PHASE)
		).setMVCRenderCommandName(
			SXPBlueprintMVCCommandNames.IMPORT
		).setRedirect(
			() -> {
