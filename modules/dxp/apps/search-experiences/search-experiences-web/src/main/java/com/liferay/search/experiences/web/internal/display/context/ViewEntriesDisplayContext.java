...
public abstract class ViewEntriesDisplayContext<R> {
	...
	public String getDisplayStyle() {
		...
		if (Validator.isNull(displayStyle)) {
			return portalPreferences.getValue(
				SXPPortletKeys.SXP_BLUEPRINTS_ADMIN, preferenceName,
				"descriptive");
		}

		portalPreferences.setValue(
			SXPPortletKeys.SXP_BLUEPRINTS_ADMIN, preferenceName, displayStyle);
	...
	protected String getMVCRenderCommandName() {
		if (tabs1.equals("sxpElements")) {
			return "/sxp_blueprints_admin/view_sxp_elements";
		}

		return "/sxp_blueprints_admin/view_sxp_blueprints";
	}
