...
import QueryBuilder from '../../../../src/main/resources/META-INF/resources/js/edit_sxp_blueprint/query_builder_tab';
...
function renderBuilder(props) {
	return render(
		<QueryBuilder
			...
			initialSelectedSXPElements={SELECTED_SXP_ELEMENTS}
...
describe('QueryBuilder', () => {
	...
	it('can expand all the query elements', () => {
		...
		expect(
			container.querySelectorAll('.configuration-form-list').length
		).toBe(SELECTED_SXP_ELEMENTS.length);
	});
});
