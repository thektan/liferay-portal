...
import JSONSXPElement from '../../../src/main/resources/META-INF/resources/js/shared/JSONSXPElement';
...
function renderJSONSXPElement(props) {
	return render(
		<JSONSXPElement
			collapseAll={false}
			description={
				SELECTED_SXP_ELEMENTS[0].sxpElementTemplateJSON.description
			}
			...
			title={SELECTED_SXP_ELEMENTS[0].sxpElementTemplateJSON.title}
			{...props}
		/>
	);
}
