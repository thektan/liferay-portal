...
public abstract class BaseEmbeddingProviderValidationResultResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v1.0/text-embeddings/validate-provider-configuration' -d $'{"attributes": ___, "cacheTimeout": ___, "embeddingVectorDimensions": ___, "providerName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
