...
public class FacetsJSONTranslationContributor
		...
		try {
			...
			Optional<JSONObject> resultOptional =
				facetResponseHandler.getResultOptional(
					...
					resourceBundle, problemsHolderBuilder, typeJSONObject);
			...
			ProblemBuilder problemBuilder = _problemBuilders.error(
				...
				null, null, type, illegalArgumentException);
	...
	private JSONObject _getFacetsJSONObject(
		...
		keySet.forEach(
			facetName -> _processFacet(
				...
				blueprintsAttributes, resourceBundle, problemsHolderBuilder));
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacetsJSONTranslationContributor.class);
