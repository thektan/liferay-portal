...
public class ClauseHelperTest {
	...
	public void setUp() throws Exception {
		...
		_clauseHelper.setProblemBuilders(problemBuilders);
	...
	public void testGetClauseWithClauseTranslator() {
		...
		Assert.assertEquals(
			Optional.of(query),
			_clauseHelper.getQueryOptional(
				JSONUtil.put("anyKey", "anyType"),
				new ParameterDataImpl("", Collections.emptyList()),
				Mockito.mock(ProblemsHolderBuilder.class)));
	}
	...
	public void testGetClauseWithNullJsonObject() {
		Assert.assertEquals(
			Optional.empty(), _clauseHelper.getQueryOptional(null, null, null));
	}
