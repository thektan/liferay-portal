...
public class ContainsVisitorTest extends BaseVisitorTestCase {
	...
	public void setUp() throws Exception {
		...
		_containsVisitor = new ContainsVisitor(
			conditionJSONObject, _problemsFixture.getProblemBuilders());
	}
	...
	private ContainsVisitor _containsVisitor;
	...
	private final ProblemsFixture _problemsFixture = new ProblemsFixture();
