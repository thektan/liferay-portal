 ...
 */
@Component(immediate = true, service = ProblemBuilderFactory.class)
public class ProblemBuilderFactoryImpl implements ProblemBuilderFactory {

	@Override
	public ProblemBuilder builder() {
		return ProblemImpl.builder();
	}

	@Override
	public ProblemBuilder builder(Problem problem) {
		return ProblemImpl.builder((ProblemImpl)problem);
	}
