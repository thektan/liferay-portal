...
public class EmbeddingProviderConfigurationSerDes {
	...
	public static String toJSON(
		...
		if (embeddingProviderConfiguration.getCacheTimeout() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(embeddingProviderConfiguration.getCacheTimeout());
		}
	...
	public static Map<String, String> toMap(
		...
		if (embeddingProviderConfiguration.getCacheTimeout() == null) {
			map.put("cacheTimeout", null);
		}
		else {
			map.put(
				"cacheTimeout",
				String.valueOf(
					embeddingProviderConfiguration.getCacheTimeout()));
		}
	...
	public static class EmbeddingProviderConfigurationJSONParser
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "cacheTimeout")) {
				if (jsonParserFieldValue != null) {
					embeddingProviderConfiguration.setCacheTimeout(
