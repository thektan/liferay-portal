...
public class ElementModelImpl
	...
	public Object clone() {
		...
		elementImpl.setHidden(isHidden());
		elementImpl.setReadOnly(isReadOnly());
	...
	public Element cloneWithOriginalValues() {
		...
		elementImpl.setMvccVersion(
			this.<Long>getColumnOriginalValue("mvccVersion"));
		elementImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		elementImpl.setElementId(
			this.<Long>getColumnOriginalValue("elementId"));
		elementImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		elementImpl.setCompanyId(
			this.<Long>getColumnOriginalValue("companyId"));
		elementImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		elementImpl.setUserName(
			this.<String>getColumnOriginalValue("userName"));
		elementImpl.setCreateDate(
			this.<Date>getColumnOriginalValue("createDate"));
		elementImpl.setModifiedDate(
			this.<Date>getColumnOriginalValue("modifiedDate"));
		elementImpl.setStatus(this.<Integer>getColumnOriginalValue("status"));
		elementImpl.setTitle(this.<String>getColumnOriginalValue("title"));
		elementImpl.setDescription(
			this.<String>getColumnOriginalValue("description"));
		elementImpl.setConfiguration(
			this.<String>getColumnOriginalValue("configuration"));
		elementImpl.setHidden(this.<Boolean>getColumnOriginalValue("hidden_"));
		elementImpl.setReadOnly(
			this.<Boolean>getColumnOriginalValue("readOnly"));
		elementImpl.setType(this.<Integer>getColumnOriginalValue("type_"));
	...
	public CacheModel<Element> toCacheModel() {
		...
		elementCacheModel.hidden = isHidden();

		elementCacheModel.readOnly = isReadOnly();
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<Element, Object>> entry :
			...
			Object value = attributeGetterFunction.apply((Element)this);
