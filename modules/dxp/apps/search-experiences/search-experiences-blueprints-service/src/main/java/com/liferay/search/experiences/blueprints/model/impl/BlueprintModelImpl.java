...
public class BlueprintModelImpl
	...
	public Blueprint cloneWithOriginalValues() {
		...
		blueprintImpl.setMvccVersion(
			this.<Long>getColumnOriginalValue("mvccVersion"));
		blueprintImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		blueprintImpl.setBlueprintId(
			this.<Long>getColumnOriginalValue("blueprintId"));
		blueprintImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		blueprintImpl.setCompanyId(
			this.<Long>getColumnOriginalValue("companyId"));
		blueprintImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		blueprintImpl.setUserName(
			this.<String>getColumnOriginalValue("userName"));
		blueprintImpl.setCreateDate(
			this.<Date>getColumnOriginalValue("createDate"));
		blueprintImpl.setModifiedDate(
			this.<Date>getColumnOriginalValue("modifiedDate"));
		blueprintImpl.setStatus(this.<Integer>getColumnOriginalValue("status"));
		blueprintImpl.setStatusByUserId(
			this.<Long>getColumnOriginalValue("statusByUserId"));
		blueprintImpl.setStatusByUserName(
			this.<String>getColumnOriginalValue("statusByUserName"));
		blueprintImpl.setStatusDate(
			this.<Date>getColumnOriginalValue("statusDate"));
		blueprintImpl.setTitle(this.<String>getColumnOriginalValue("title"));
		...
		blueprintImpl.setSelectedElements(
			this.<String>getColumnOriginalValue("selectedElements"));
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<Blueprint, Object>> entry :
			...
			Object value = attributeGetterFunction.apply((Blueprint)this);
